...
This module provides functions for extracting and organizing
...
- Label remapping based on spatial ordering

Example usage:
    import numpy as np
    from photomap import find_grid
    
    # Remap labels by spatial position
    new_labels = find_grid.remap_labels(labels, points, axis=1)
    
    # Organize points into structured grid
    grid_results = find_grid.reorganize_points_into_grid(
        points, row_labels, column_labels, plane_labels, sample_labels
    )
"""
